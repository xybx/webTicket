...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'usernickname', label: '许愿时的昵称',sortable:false},

                    {prop: 'wishaddress', label: '发起许愿的位置',sortable:false},

                    {prop: 'wishcontent', label: '许愿内容',sortable:false},

                    {prop: 'wiship', label: '许愿的ip',sortable:false},

                    {prop: 'wishnum', label: '许愿编号',sortable:false},

                    {prop: 'wishtime', label: '许愿日期',sortable:false},

                    {prop: 'wishtype', label: '许愿类型',sortable:false,list:wishtypeSelectData.value },

                    {prop: 'assist', label: '助力次数',sortable:false},

                    {prop: 'complete', label: '愿望是否完成',sortable:false,list:commonSelectData.value},

                    {prop: 'ispublic', label: '是否公开',sortable:false,list:publicData.value},

                    {prop: 'receivecode', label: '愿望查看验证码',sortable:false},

                    {prop: 'receivemobile', label: '愿望接收人手机号',sortable:false},

                    {prop: 'receivestatue', label: '是否接收',sortable:false,list:commonSelectData.value},

                    {prop: 'updatetime', label: '数据更新时间',sortable:false},
