...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'nickname', label: '昵称',sortable:false},
                    {prop: 'wishpower', label: '心愿力',sortable:false},
                    {prop: 'status', label: '用户状态',sortable:false,list:statusSelectData.value },
                    {prop: 'createdtime', label: '注册时间',sortable:false},
                    {prop: 'updatedby', label: '更新人',sortable:false},
                    {prop: 'updatedtime', label: '更新时间',sortable:false},
                    {prop: 'loginip', label: '登录ip',sortable:false},
                    {prop: 'logindate', label: '登录时间',sortable:false},
                    {prop: 'loginaddress', label: '登录地点',sortable:false},
