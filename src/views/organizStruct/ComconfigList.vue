...
<script setup lang="ts">
  ...
  import editDialog from "/@/views/appInfo/components/ComconfigDialog.vue";
  import lookDialog from "/@/views/appInfo/components/ComconfigDetail.vue";
  import type {
    TableColumnProps,
    TableProps,
    ButtonProps,
    JsonProps,
    DialogProps,
  } from "/@/types/appinfo/ComconfigTypes";
  import { getDataListApi, del, putMultiDel
  } from "/@/api/appinfo/ComconfigApi";
  ...
  const getTableColumns = () => {
    tableColumns.value = [
    {prop: 'skey', label: '配置名称',sortable:true},
    {prop: 'svalue', label: '配置值',sortable:false},
   {prop: 'sdescribe', label: '描述',sortable:false},
