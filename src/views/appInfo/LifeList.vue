...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'nickname', label: '发布人',sortable:false},

                    {prop: 'addtime', label: '发布时间',sortable:false},

                    {prop: 'scontent', label: '发布内容',sortable:false},

                    {prop: 'likes', label: '点赞数量',sortable:false},

                    {prop: 'comments', label: '评论数量',sortable:false},

                    {prop: 'ischeck', label: '审核状态',sortable:false,list:ischeckSelectData.value },

                    {prop: 'isdel', label: '删除状态',sortable:false,list:isdelSelectData.value }
