...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'nickname', label: '留言人',sortable:false},

                    {prop: 'mobile', label: '联系方式',sortable:false},

                    {prop: 'addtime', label: '留言时间',sortable:false},

                    {prop: 'ip', label: 'ip',sortable:false},
                    {prop: 'address', label: '地址',sortable:false},
                    {prop: 'isused', label: '是否采纳',sortable:false},
