...
<script setup lang="ts">
  ...
  const getTableColumns = () => {
    tableColumns.value = [
                    {prop: 'replynickname', label: '回复人',sortable:false},

                    {prop: 'replytime', label: '回复时间',sortable:false},

                    {prop: 'replycontent', label: '回复内容',sortable:false},

                    {prop: 'stype', label: '消息类型',sortable:false},

                    {prop: 'statue', label: '是否查看',sortable:false,list:statueSelectData.value },
