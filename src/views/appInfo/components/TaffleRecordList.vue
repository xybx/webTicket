<template>
  ...
  <script setup lang="ts">
    ...
    const getTableColumns = () => {
      tableColumns.value = [
                      {prop: 'usernickname', label: '抽奖人昵称',sortable:false},
  
                      {prop: 'addtime', label: '抽奖时间',sortable:false},
  
                      {prop: 'payscore', label: '花费心愿力',sortable:false},
  
                      {prop: 'ishit', label: '是否中奖',sortable:false,list:ishitSelectData.value },
  
                      {prop: 'iscash', label: '是否兑现',sortable:false,list:iscashSelectData.value },
  
                      {prop: 'cashtime', label: '兑现时间',sortable:false},
  
                      {prop: 'operuser', label: '兑现操作人',sortable:false},
