...
const getTopButton = (arr: ButtonProps[]) => {
  ...
  BtnArr.value = [
    ...
    { name: "查看评论", color: '#af52e7',funName: "lookLifeCommentClick" },
    { name: "查看点赞", color: '#af52e7',funName: "lookLifeLikeCommentClick" },
    { name: "核实", color: '#af52e7',funName: "updateChecckClick" },
    { name: "一键下载", color: '#af52e7',funName: "allDownClick" },
    { name: "下载", color: '#af52e7',funName: "downFileClick" },
